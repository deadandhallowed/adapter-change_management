...
class ServiceNowConnector {
   ...
   * @description A [callback method]{@link
   *   https://developer.mozilla.org/en-US/docs/Glossary/Callback_function}
   *   is a method passed into another method as an argument, which is
   *   then invoked inside the outer method to complete some kind of
   *   routine or action.
   *
   * @param {*} responseData - When no errors are caught, return data as a
   *   single argument to callback method.
   * @param {error} [errorMessage] - If an error is caught, return error
   *   message in optional second argument to callback method.
   */
   ...
   *
   * @param {iapCallback} callback - Callback a method.
 ...
 * @memberof ServiceNowConnector
 * @method post
 * @summary Call the ServiceNow POST API.
 ...
 * @summary Checks request method.
 * @description Checks if request method responded with evidence of
 *   a hibernating ServiceNow instance.
 *
 * @param {object} response - The response argument passed by the request method in its callback.
 *
...
isHibernating(response) {
  ...
  && response.body.includes('<html>') && response.statusCode === 200;
}
 ...
 *
 * @param {error} error - The error argument passed by the request method in its callback.
 * @param {object} response - The response argument passed by the request method in its callback.
 * @param {string} body - The HTML body argument passed by the request method in its callback.
 * @param {iapCallback} callback - Callback a method.
 * @param {(object|string)} callback.data - The API's response. Will be an object if sunnyday path.
 *   Will be HTML text if hibernating instance.
 * @param {error} callback.error - The error property of callback.
 ...
 * @memberof ServiceNowConnector
 * @method sendRequest
 * @summary Builds final options argument for request method.
